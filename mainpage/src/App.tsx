    ...
    <div className="App">
      ...
      <main className="projects">
        <ProjectBlock title="Fancy Mumble Web" href="https://mumble.magical.rocks">
          <ImageContainer src={process.env.PUBLIC_URL + '/img/fmw.jpg'} alt="Fancy Mumble Website"/>
        ...
        <ProjectBlock title="A4963 Flashing Software" href="https://github.com/SetZero/A4963">
          <ImageContainer src={process.env.PUBLIC_URL + '/img/devBoard_small.jpg'} alt="A4963 Test Developement Board"/>
        ...
        <ProjectBlock title="AVR Generic Bootloader" href="https://github.com/firmware-loader">
          <ImageContainer src={process.env.PUBLIC_URL + '/img/heater_small.jpg'} alt="Custom reflow vven board which was the main target the software has been tested on"/>
        ...
        <ProjectBlock title="Battery Powered WiFi Thermometer" href="https://dauenhauer.cc">
          <ImageContainer src={process.env.PUBLIC_URL + '/img/tempBoard_small.jpg'} alt="Battery Powered WiFi Thermometer Developement Board"/>
